...
(function () {
  ...
  style.textContent = `
    ...
    #gl-warn-title { font-size: 1rem; font-weight: 700; color: #f59e0b; }
    #gl-warn-sub   { font-size: .72rem; color: #64748b; margin-top: 2px; }
    #gl-warn-close {
    ...
    .gl-info-pill-label { color: #64748b; min-width: 58px; font-size: .7rem; }
    .gl-info-pill-value { color: #e2e8f0; font-weight: 500; word-break: break-all; }
    .gl-info-pill-value.mono { font-family: 'JetBrains Mono', monospace; font-size: .72rem; color: #f59e0b; }
    ...
    #gl-chat-status { font-size: .68rem; color: #22c55e; display:flex;align-items:center;gap:4px; }
    ...
    #gl-chat-section.open { max-height: 320px; }
    ...
    #gl-chat-send {
      ...
      padding:.48rem .75rem; color:#000; font-size:.9rem;
