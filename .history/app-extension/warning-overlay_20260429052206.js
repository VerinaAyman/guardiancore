...
(function () {
  ...
  document.getElementById('gl-open-lens-btn').addEventListener('click', () => {
    dismissOverlay();
    setTimeout(() => {
      // Try clicking the FAB first
      const fab = document.getElementById('gl-lens-fab');
      if (fab) {
        fab.click();
        // Then find and click the chat panel toggle to open it
        setTimeout(() => {
          const panel = document.getElementById('gl-lens-panel');
          const toggle = document.getElementById('gl-lens-toggle');
          if (panel && !panel.classList.contains('open')) {
            if (toggle) toggle.click();
          }
          // Focus the input
          const input = document.getElementById('gl-lens-input');
