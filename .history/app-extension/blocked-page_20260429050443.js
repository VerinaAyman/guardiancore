...
function notifyParent() {
  if (typeof chrome !== 'undefined' && chrome.runtime) {
    ...
    chrome.runtime.sendMessage({
      type: 'PAGE_BLOCKED',
      url:      params.get('url')      || document.referrer || window.location.href,
      reason:   params.get('reason')   || 'Content policy violation',
      category: params.get('category') || 'blocked_content'
    });
  }
}
