...
Get-Content "C:\Users\HP\OneDrive\Documents\GitHub\guardiancore\app-extension\blocked.html"
  } catch (error) {
...
if (riskScore >= 5 && sender.tab && sender.tab.id) {
  ...
  chrome.tabs.sendMessage(sender.tab.id, {
    ...
    reason:   result.child_message || result.reason || "This page has some content worth talking about."
  }).catch(() => {}); // tab may not have lens-bubble.js yet — safe to ignore
}
