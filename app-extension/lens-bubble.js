...
(function () {
  ...
  style.textContent = `
    ...
    #gl-panel { position:fixed;bottom:96px;right:24px;width:420px;max-height:620px;background:#0b1120;border:1px solid #1e293b;border-radius:24px;display:none;flex-direction:column;overflow:hidden;box-shadow:0 28px 70px rgba(0,0,0,.75),0 0 0 1px rgba(255,255,255,.04);z-index:2147483645;transform-origin:bottom right; }
    ...
    .gl-msg { max-width:88%;padding:.6rem 1rem;border-radius:1.1rem;font-size:.95rem;line-height:1.65;font-weight:500;animation:glMsgIn .25s cubic-bezier(.34,1.56,.64,1) both; }
    ...
    #gl-input { flex:1;background:#111827;border:1.5px solid #1e293b;border-radius:.7rem;color:#f1f5f9;font-family:'Sora',sans-serif;font-size:1rem;font-weight:500;padding:.52rem .85rem;outline:none;transition:border-color .2s,box-shadow .2s; }
